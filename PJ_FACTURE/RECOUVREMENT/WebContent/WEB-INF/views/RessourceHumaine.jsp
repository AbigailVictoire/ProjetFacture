...
<title>RESSOURCE HUMAINNES</title>
     ...
     <div class="container-fluid" style="">
			...
			<div class="container" style="margin-left: 0;">
						<div class="table" id="table1">
							<div class="thead">
								<div class="tr">
									<div class="td" style="">N° EMPLOYE</div>
									<div class="td" style="">NOM </div>
									<div class="td" style="">PRENOM</div>
									<div class="td" style="">ADRESSE</div>
									<div class="td" style="">DATE EMBAUCHE</div>
									<div class="td" style="">POSTE</div>
								</div>
							</div>
							<div class="tbody" id="tbody">
								<c:forEach items="${listRH.rows}" var="mapRH" varStatus="boucle">
									<div class="tr ${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
										<div class="td" style="text-align:center;">${boucle.index + 1}</div>
										<div class="td">${mapRH.nom} </div>
										<div class="td" style="text-align:center;">${mapRH.prenom}</div>
										<div class="td" style="text-align:center;">${mapRH.date_embauche}</div>
										<div class="td" style="text-align:center;">${mapRH.poste_id}</div>
