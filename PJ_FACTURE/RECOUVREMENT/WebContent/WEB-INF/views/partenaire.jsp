						...
						<div class="table" id="table1">
							<div class="thead">
								<div class="tr">
									...
									<div class="td" style="">NOM PARTENAIRE</div>
									<div class="td" style="">TYPE PARTENAIRE</div>
									
								</div>
							</div>
							<div class="tbody" id="tbody">
								<c:forEach items="${listPar.rows}" var="mapAd" varStatus="boucle">
									<div class="tr ${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
										<div class="td" style="text-align:center;">${boucle.index + 1}</div>
										<div class="td">${mapPar.nom_partenaire} </div>
										<div class="td" style="text-align:center;">${mapPar.type_partenaire}</div>
