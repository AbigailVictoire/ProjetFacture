     ...
     <div class="container-fluid" style="">
			...
			<div class="container" style="margin-left: 0;">
						<div class="table" id="table1">
							<div class="thead">
								<div class="tr">
									<div class="td" style="">N° STATISTIQUES</div>
									<div class="td" style="">TYPE STATISTIQUES</div>
									<div class="td" style="">VALEUR</div>
									
								</div>
							</div>
							<div class="tbody" id="tbody">
								<c:forEach items="${listStat.rows}" var="mapAd" varStatus="boucle">
									<div class="tr ${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
										<div class="td" style="text-align:center;">${boucle.index + 1}</div>
										<div class="td">${mapStat.type_statistique} </div>
										<div class="td" style="text-align:center;">${mapStat.valeur}</div>
