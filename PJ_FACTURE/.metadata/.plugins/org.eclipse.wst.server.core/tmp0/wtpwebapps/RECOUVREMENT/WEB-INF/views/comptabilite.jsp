     ...
     <div class="container-fluid" style="">
			...
			<div class="container" style="margin-left: 0;">
						<div class="table" id="table1">
							<div class="thead">
								<div class="tr">
									<div class="td" style="">N° TRANSACTION</div>
									<div class="td" style="">DATE  </div>
									<div class="td" style="">MONTANT</div>
									<div class="td" style="">TYPE TRANSACTION</div>
									
								</div>
							</div>
							<div class="tbody" id="tbody">
								<c:forEach items="${listCompta.rows}" var="mapRH" varStatus="boucle">
									<div class="tr ${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
										<div class="td" style="text-align:center;">${boucle.index + 1}</div>
										<div class="td">${mapCompta.date} </div>
										<div class="td" style="text-align:center;">${mapCompta.montant}</div>
										<div class="td" style="text-align:center;">${mapCompta.typeTrans}</div>
