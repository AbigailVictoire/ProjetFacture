...
function plusMoins(mode) {
    ...
    if (mode == 'envoi') {
        ...
        if (signe == 'globale') {
            ...
            if (Gtype == '') {
                document.getElementById("AlP").innerHTML = "Veuillez sélectionner le type.";
                document.getElementById("msgN").style.display = "block";
                return false;
            }
            if (Gmax == '') {
                document.getElementById("AlP").innerHTML = "Veuillez sélectionner la note maxi.";
                document.getElementById("msgN").style.display = "block";
                return false;
            }
            if (Gcoef == '') {
                document.getElementById("AlP").innerHTML = "Veuillez sélectionner le coefficient.";
                document.getElementById("msgN").style.display = "block";
                return false;
            }
            if (isNaN(plus)) {
